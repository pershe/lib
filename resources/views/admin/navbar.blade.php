    ...
    <div class="fixed left-0 top-0 w-64 h-full bg-[#f8f4f3] p-4 z-50 sidebar-menu transition-transform">
        ...
        <ul class="mt-4">
            ...
            <li class="mb-1 group">
                ...
                <ul class="pl-7 mt-2  ">
                    <li class="mb-4">
                        <a href="{{ route('admin.petugas') }}" class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Petugas</a>
                    </li>
                    <li class="mb-4">
                        <a href="{{ route('admin.peminjam') }}" class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Peminjam</a>
                    </li>
                </ul>
            ...
            <li class="mb-1 ">
                ...
                <ul class="pl-7 mt-2  ">
                    <li class="mb-4">
                        <a href="{{ route('admin.books') }}" class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">book</a>
                    </li>
                    <li class="mb-4">
                        <a href="{{ route('admin.histori.peminjaman') }}" class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">loans history</a>
                    </li>
                </ul>
            </li>
        </ul>
