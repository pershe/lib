...
[type='reset'],
[type='submit'] {
  appearance: button; /* Properti standar */
  -webkit-appearance: button; /* Untuk Safari */
  -moz-appearance: button; /* Untuk Firefox */
...
[type='search'] {
  appearance: textfield; /* Properti standar */
  -webkit-appearance: textfield; /* Untuk Safari & Chrome lama */
...
embed,
object {
  display: block; /* Elemen menjadi block-level */
}
...
<body class="text-gray-800 font-inter">
    ...
    <div class="fixed left-0 top-0 w-64 h-full bg-[#f8f4f3] p-4 z-50 sidebar-menu transition-transform">
        <a href="#" class="flex items-center pb-4 border-b border-b-gray-800">
            ...
            <h2 class="font-bold text-2xl">LIBRA <span class="bg-[#f84525] text-white px-2 rounded-md">library</span></h2>
        </a>
        <ul class="mt-4">
            <span class="text-gray-400 font-bold">PETUGAS</span>
            <li class="mb-1 group">
                <a href="{{ route('petugas.dashboard') }}" class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
                    <i class="ri-home-2-line mr-3 text-lg"></i>
                    <span class="text-sm">Dashboard</span>
                </a>
                <li class="mb-1 group">
                <a href="{{route('peminjam.data')}}" class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
                    <i class="bx bx-user mr-3 text-lg"></i>
                    <span class="text-sm">data peminjam</span>
                </a>

                <li class="mb-1 group">
                <a href="{{ route('peminjaman.index') }}" class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
                    <i class="bx bx-book-reader mr-3 text-lg"></i>
                    <span class="text-sm">loans</span>
                </a>
                <a href="{{ route('peminjaman.histori') }}" class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
                    <i class="ri-home-2-line mr-3 text-lg"></i>
                    <span class="text-sm">Loans History</span>
                </a>
            </li>
            <li class="mb-1 ">
                <a href="" class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100 sidebar-dropdown-toggle">
                    <i class='bx bx-book-content mr-3 text-lg'></i>
                    <span class="text-sm">book</span>
                </a>
                <ul class="pl-7 mt-2  ">
                    <li class="mb-4">
                        <a href="{{ route('kategori.index') }}" class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">category</a>
                    </li>
                    <li class="mb-4">
                        <a href="{{ route('book.data') }}" class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">book</a>
                    </li>
                </ul>
            </li>
            <li class="mb-1 group">
                <a href="{{ route('denda.index') }}" class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
                    <i class='bx bx-money mr-3 text-lg'></i>
